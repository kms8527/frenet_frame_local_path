...
asn_TYPE_descriptor_t asn_DEF_regional_3 = {
	...
	{ 0, &asn_PER_type_regional_constr_3, SEQUENCE_OF_constraint },
	asn_MBR_regional_3,
	1,	/* Single element */
...
asn_TYPE_member_t asn_MBR_RestrictionUserType_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct RestrictionUserType, choice.regional),
		...
		&asn_DEF_regional_3,
		0,
		{ 0, &asn_PER_memb_regional_constr_3,  memb_regional_constraint_1 },
		0, 0, /* No default value */
		"regional"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_RestrictionUserType = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_RestrictionUserType_constr_1, CHOICE_constraint },
