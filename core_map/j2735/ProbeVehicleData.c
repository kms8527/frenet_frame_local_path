...
asn_TYPE_descriptor_t asn_DEF_snapshots_7 = {
	...
	{ 0, &asn_PER_type_snapshots_constr_7, SEQUENCE_OF_constraint },
	asn_MBR_snapshots_7,
	1,	/* Single element */
...
asn_TYPE_descriptor_t asn_DEF_regional_9 = {
	...
	{ 0, &asn_PER_type_regional_constr_9, SEQUENCE_OF_constraint },
	asn_MBR_regional_9,
	1,	/* Single element */
...
asn_TYPE_member_t asn_MBR_ProbeVehicleData_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ProbeVehicleData, snapshots),
		...
		&asn_DEF_snapshots_7,
		0,
		{ 0, &asn_PER_memb_snapshots_constr_7,  memb_snapshots_constraint_1 },
		0, 0, /* No default value */
		"snapshots"
		},
	{ ATF_POINTER, 1, offsetof(struct ProbeVehicleData, regional),
		...
		&asn_DEF_regional_9,
		0,
		{ 0, &asn_PER_memb_regional_constr_9,  memb_regional_constraint_1 },
		0, 0, /* No default value */
		"regional"
		},
};
