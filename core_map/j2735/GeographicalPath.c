...
asn_TYPE_descriptor_t asn_DEF_description_9 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_description_constr_9, CHOICE_constraint },
...
asn_TYPE_descriptor_t asn_DEF_regional_14 = {
	...
	{ 0, &asn_PER_type_regional_constr_14, SEQUENCE_OF_constraint },
	asn_MBR_regional_14,
	1,	/* Single element */
...
asn_TYPE_member_t asn_MBR_GeographicalPath_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct GeographicalPath, regional),
		...
		&asn_DEF_regional_14,
		0,
		{ 0, &asn_PER_memb_regional_constr_14,  memb_regional_constraint_1 },
		0, 0, /* No default value */
		"regional"
		},
};
