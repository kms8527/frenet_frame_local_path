...
asn_TYPE_descriptor_t asn_DEF_msgId_4 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_msgId_constr_4, CHOICE_constraint },
	asn_MBR_msgId_4,
	2,	/* Elements count */
...
asn_TYPE_descriptor_t asn_DEF_regions_12 = {
	...
	{ 0, &asn_PER_type_regions_constr_12, SEQUENCE_OF_constraint },
	asn_MBR_regions_12,
	1,	/* Single element */
...
asn_TYPE_descriptor_t asn_DEF_content_16 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_content_constr_16, CHOICE_constraint },
	asn_MBR_content_16,
	5,	/* Elements count */
...
asn_TYPE_member_t asn_MBR_TravelerDataFrame_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct TravelerDataFrame, regions),
		...
		&asn_DEF_regions_12,
		0,
		{ 0, &asn_PER_memb_regions_constr_12,  memb_regions_constraint_1 },
		0, 0, /* No default value */
		"regions"
		},
