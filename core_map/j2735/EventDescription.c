...
asn_TYPE_descriptor_t asn_DEF_description_3 = {
	...
	{ 0, &asn_PER_type_description_constr_3, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_regional_8 = {
	...
	{ 0, &asn_PER_type_regional_constr_8, SEQUENCE_OF_constraint },
	asn_MBR_regional_8,
	1,	/* Single element */
...
asn_TYPE_member_t asn_MBR_EventDescription_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct EventDescription, description),
		...
		0,
		{ 0, &asn_PER_memb_description_constr_3,  memb_description_constraint_1 },
		0, 0, /* No default value */
		"description"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct EventDescription, regional),
		...
		&asn_DEF_regional_8,
		0,
		{ 0, &asn_PER_memb_regional_constr_8,  memb_regional_constraint_1 },
		0, 0, /* No default value */
		"regional"
		},
};
