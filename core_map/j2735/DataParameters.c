...
asn_TYPE_member_t asn_MBR_DataParameters_1[] = {
	{ ATF_POINTER, 4, offsetof(struct DataParameters, processMethod),
		...
		&asn_DEF_IA5String,
		0,
		{ 0, &asn_PER_memb_processMethod_constr_2,  memb_processMethod_constraint_1 },
	...
	{ ATF_POINTER, 3, offsetof(struct DataParameters, processAgency),
		...
		&asn_DEF_IA5String,
		0,
		{ 0, &asn_PER_memb_processAgency_constr_3,  memb_processAgency_constraint_1 },
		0, 0, /* No default value */
		"processAgency"
		},
	{ ATF_POINTER, 2, offsetof(struct DataParameters, lastCheckedDate),
		...
		&asn_DEF_IA5String,
		0,
		{ 0, &asn_PER_memb_lastCheckedDate_constr_4,  memb_lastCheckedDate_constraint_1 },
		0, 0, /* No default value */
		"lastCheckedDate"
		},
	{ ATF_POINTER, 1, offsetof(struct DataParameters, geoidUsed),
		...
		&asn_DEF_IA5String,
		0,
		{ 0, &asn_PER_memb_geoidUsed_constr_5,  memb_geoidUsed_constraint_1 },
		0, 0, /* No default value */
		"geoidUsed"
		},
};
