...
asn_TYPE_descriptor_t asn_DEF_term_5 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_term_constr_5, CHOICE_constraint },
	asn_MBR_term_5,
	2,	/* Elements count */
...
asn_TYPE_descriptor_t asn_DEF_snapshot_8 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_snapshot_constr_8, CHOICE_constraint },
	asn_MBR_snapshot_8,
	2,	/* Elements count */
...
asn_TYPE_descriptor_t asn_DEF_regional_13 = {
	...
	{ 0, &asn_PER_type_regional_constr_13, SEQUENCE_OF_constraint },
	asn_MBR_regional_13,
	1,	/* Single element */
...
asn_TYPE_member_t asn_MBR_ProbeDataManagement_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct ProbeDataManagement, regional),
		...
		&asn_DEF_regional_13,
		0,
		{ 0, &asn_PER_memb_regional_constr_13,  memb_regional_constraint_1 },
		0, 0, /* No default value */
		"regional"
		},
};
