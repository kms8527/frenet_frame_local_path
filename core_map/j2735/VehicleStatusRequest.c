...
asn_TYPE_member_t asn_MBR_VehicleStatusRequest_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct VehicleStatusRequest, subType),
		...
		0,
		{ 0, &asn_PER_memb_subType_constr_3,  memb_subType_constraint_1 },
		0, 0, /* No default value */
		"subType"
		},
	{ ATF_POINTER, 3, offsetof(struct VehicleStatusRequest, sendOnLessThenValue),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_sendOnLessThenValue_constr_4,  memb_sendOnLessThenValue_constraint_1 },
		0, 0, /* No default value */
		"sendOnLessThenValue"
		},
	{ ATF_POINTER, 2, offsetof(struct VehicleStatusRequest, sendOnMoreThenValue),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_sendOnMoreThenValue_constr_5,  memb_sendOnMoreThenValue_constraint_1 },
		0, 0, /* No default value */
		"sendOnMoreThenValue"
		},
